...
$logname=addslashes($_GET['logname']);

include 'include/onlyou_huhu.php';//


$Description=1;//headmb

if ($huifu>0) {
$sql="select * from `{$fkduo}card` where (`cid`='$cid' and `hs`='0' and `lastlogname`='$logname') order by lasttime limit $start,$contentstep";
