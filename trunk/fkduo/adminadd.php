...
<table width="36%" border="0" cellpadding="0"
	...
	<tr>
		<td>用户名</td>
		<td><label> <input type="text" name="logname" accesskey="2" /> </label>
		</td>
		<td></td>
	</tr>
	...
	<tr>
		<td>管理密码</td>
		<td><label> <input type="password" name="password" accesskey="3" /> </label>
		</td>
		<td><label> <input type="submit" name="Submit" value="添 加"
			accesskey="4" /> </label></td>
	</tr>
